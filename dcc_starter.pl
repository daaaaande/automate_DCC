...
my$dcc_err=system("DCC $bothlanesname -mt1 $laneonename.Chimeric.out.junction -mt2 $lanetwoname.Chimeric.out.junction -D -fg -an ../hg19_ens.gtf -Pi -M -Nr 1 1 -A ../hg19.fa -N -T 10 -an ../hg19_ref1.gtf");
